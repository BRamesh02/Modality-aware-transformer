...
def bootstrap_analysis(
    strategy_returns: pd.Series, n_samples: int = 1000, block_size: int = 22
):
...
def plot_bootstrap_scientific(
    sharpes: np.ndarray, metrics: pd.Series, title: str, save_path
):
